...
With the rapid advancement of digital technology, traditional banking methods are evolving into online platforms that offers users the ability to manage finances anytime and anywhere. Onile banking systems have emerged as an essential component of modern financial services, replacing time-consuming paperwork and in-person transactions with efficient, secure, and accessible web-based alternatives. However, many existing platforms still struggle with issues related to user experience, fraud prevention, and automated decision-making for banking operations such as loans.
...
The purpose of FinNova is to modernise and secure the banking experience by:
-	Detecting fraudulent login attempts to safeguard user accounts.
...
-	Account: Represents each user’s bank account type, and status.
-	Transaction: Records each transaction made by the user, including type, amount, and timestamp.
-	Loan: Captures details of loan applications, repayment status, and EMI schedules.
